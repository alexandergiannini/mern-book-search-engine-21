...
const SearchBooks = () => {
  ...
  const handleSaveBook = async (bookId) => {
    ...
    try {
      const response = await saveBook({variables: {bookData: {...bookToSave}}}); ///saveBook is from earlier

      // const response = await saveBook(bookToSave, token); ///saveBook is from earlier
